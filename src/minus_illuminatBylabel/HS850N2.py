...
# 循环读取文件下的csv文件
# 遍历指定目录下所有文件,显示所有文件名
files = os.listdir('../../DataSource/RFBG-PolyimideSMF28E/20220711-850-re4.5h/regenerationOSA-T')
# print('dirName: ', files)
times = []
ctwls = []
depth = []
...
for i, path in enumerate(files):
    ...
    if path.find('.CSV') > 0:
        # print('****************')
        print(path)
        rfbgT = readT('../../DataSource/RFBG-PolyimideSMF28E/20220711-850-re4.5h/regenerationOSA-T' + '/' +path, 12000, '../../DataSource/RFBG-PolyimideSMF28E/20220711-850-re4.5h/originalSpec.CSV')
...
df['reflection/%'] = rs
df['n_ac'] = ns
df.to_csv("../../resultDatas/20220711-850-SMF28E/PI-RFBG-850-T.csv")
...
df.to_csv("../../resultDatas/20220711-850-SMF28E/PI-RFBG-850-R.csv")
