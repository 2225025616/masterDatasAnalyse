...
#  20220711 实验数据导出
# datasT = transTDatas(
#     "../../DataSource/RFBG-PolyimideSMF28E/20220711/regenerationOSA-T")
# # print('TTTTTTTTTTTTTTTTTTTTTTTT')
# datasTemp = transTempDatas(
#     "../../DataSource/RFBG-PolyimideSMF28E/20220711/TEMP-Check")
# # print('*******************')
# datasR = transRDatas(
#     "../../DataSource/RFBG-PolyimideSMF28E/20220711/regenerationOSA-R")
